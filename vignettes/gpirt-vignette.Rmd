...
Note the messages printed by `as.response_matrix()`, lets us know which unanimous items had to be discarded).
...
Then we can get estimates of our ideology parameters (by taking the mean of the columns of `samples[["theta"]]`) without ever having to
